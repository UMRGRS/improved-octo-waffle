        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 d-flex align-items-center">
                    <a class="text-white" href="javascript:window.history.back();">
                ...
                <div class="col-lg-10 collapse navbar-collapse" id="navbarsExample04">
                    <ul class="navbar-nav ms-auto mb-2">
                        <li class="nav-item">
                            <a class='nav-link d-flex text-white fs-5 ms-2 mt-3' href='index.php'>Home</a>
                        </li>
                        <li class="nav-item">
                            <a class='nav-link d-flex text-white fs-5 ms-2 mt-3' href='about.php'>About us</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="d-flex justify-content-center me-3">
                            <?php
                                if(session_status() == PHP_SESSION_ACTIVE and isset($_SESSION["userID"])){
                                    include_once("../Archives_include_en/profilebutton.html");
                                }
                                else{
                                    include_once("../Archives_include_en/login_modal.php");
                                }
                            ?>
                        </li>
                    </ul>
