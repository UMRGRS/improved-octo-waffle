    ...
    <div class="card">
        <div class="row g-0 card-body">
            <div class="d-flex col-3 justify-content-center align-items-center">
                <img src="../assets/images/procesador/<?php echo $row["imagen"];?>" class="img-fluid rounded" style="max-height: 230px; max-width:230px;">
            </div>
            <div class="col-9">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <p class="fs-5">CPU Cores/treads</p>
                        </div>
                        <div class="col-lg-3">
                            <p class="fs-5"><?php echo $row["nucleos"];?></p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <p class="fs-5">Integrated graphics</p>
                        </div>
                        <div class="col-lg-2">
                            <p class="fs-5"><?php echo YesNo($row["igpu"]);?></p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-lg-2">
                            <p class="fs-5">Cooler</p>
                        </div>
                        <div class="col-lg-2">
                            <p class="fs-5"><?php echo YesNo($row["disipador"]);?></p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
