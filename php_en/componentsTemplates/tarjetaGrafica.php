        ...
        <div class="row g-0 card-body">
            ...
            <div class="col-9">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <p class="fs-5">Assembler</p>
                        </div>
                        <div class="col-lg-2">
                            <p class="fs-5"><?php echo $row["ensamblador"];?></p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <p class="fs-5"><?php echo $row["gddr"];?></p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-lg-2">
                            <p class="fs-5">Displayport</p>
                        </div>
                        <div class="col-lg-2">
                            <p class="fs-5"><?php echo $row["displayport"];?>x</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <p class="fs-5"><?php echo $row["hdmi"];?>x</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-lg-2">
                            <p class="fs-5">Number of slots</p>
                        </div>
                        <div class="col-lg-2">
                            <p class="fs-5"><?php echo $row["slots"];?></p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-lg-2">
                            <p class="fs-5">Length</p>
                        </div>
                        <div class="col-lg-2">
                            <p class="fs-5"><?php echo $row["longitud"];?></p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
